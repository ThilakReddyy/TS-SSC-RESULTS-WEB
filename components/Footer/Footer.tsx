    ...
    return (
        <>
            ...
            <p className="mt-4 block text-left mx-[18%] text-center mb-4 text-[75%] sm:text-[100%]">
                ...
                <a target="_blank" href="https://github.com/ThilakReddyy/" className=" underline	underline-offset-1" >
                    Thilak Reddy
                </a>
            ...
            <p className="mt-1 block text-left mx-[18%] text-center mb-4 text-[75%] sm:text-[100%]">
                ...
                <a target="__blank" href="https://www.buymeacoffee.com/thilakreddy" className="underline	underline-offset-1">
                    buying me a pizza.
                </a>
