...
const NavMenu = ({ handleNavBar }) => {
    ...
    return (<>
        <div className={`${inter.variable} font-Inter font-sans fixed  z-10
        
         w-full bg-white h-full mt-[60px] md:mt-[0px]  mr-0 shadow-xl md:flex md:h-[20px] md:shadow-none md:w-auto md:right-[150px]`}>
            ...
            <div className='bottom-0 md:hidden fixed w-full'>
                <center >
                    ...
                    <div className="flex justify-center m-2 text-xs	 text-gray-600">
                        <p>&copy; 2023 TS-SSC Results. All rights reserved.</p>
                    </div>
