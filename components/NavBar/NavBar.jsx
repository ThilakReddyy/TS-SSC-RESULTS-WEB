...
const NavBar = () => {
    ...
    return (<>
        ...
        <nav className="shadow-xl flex py-[14px] h-[60px] w-full items-center md:px-[20px] md:mb-[20px] bg-white fixed" >
            ...
            <div id="nav-menu">
                <div className={` fixed top-0 left-0 z-50 ${NavMenuOpen ? 'block opacity-100' : 'hidden opacity-0 pointer-events-none'}  md:block md:opacity-100 md:pointer-events-auto md:left-auto md:py-[20px]`}  >
